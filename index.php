...
<h1 align="center" class="judul">Kalkulator IMT</h1>
    <div class="container d-flex justify-content-center">
        <div class="card mt-4" style="width:18rem">
            <div class="card-header">Kalkulator IMT PHP</div>
            <div class="card-body">
                <form action="" method="get">
                    ...
                    <button type="suIMTt" name="proses" class="btn btn-success btn-sm">Hitung</button>
                </form>
            </div>
        </div>
    </div>
